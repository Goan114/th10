...
__attribute__((export_name("sdl_loop_pause"))) void sdl_loop_pause(th10::u32 pause){suspended=pause!=0;last=-1;cadence.reset();sdl_audio_pause(pause);}
__attribute__((export_name("sdl_loop_start"))) void sdl_loop_start(th10::browser::Application* app){
    application=app;elapsed=audio_remainder=0;cadence.reset();last=-1;callback_begin=emscripten_get_now();running=true;
