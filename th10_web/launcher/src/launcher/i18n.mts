...
const entries = [
  ["site.documentTitle", "东方风神录网页版", "Touhou 10: Mountain of Faith — Web"],
  ["site.description", "东方风神录网页版，支持日文、简体中文、触控和离线游玩。", "Touhou 10 in the browser, with Japanese, Simplified Chinese, touch controls and offline play."],
  ...
  ["settings.touchLayoutShared", "拖动并缩放触控按键，设置会自动保存", "Position and size are shared by TH06 / TH07"],
  ...
  ["multiplayer.ownerLocalHint", "你当前坐在 P1，可以修改房间设置。修改设置不会取消其他玩家的准备状态。", "You are in P1 and can change room settings. Changes do not clear other players' ready state."],
  ...
  ["multiplayer.waitSpectatorStream", "等待本局开始；开局后短时间内仍可加入当前旁观流", "Waiting for the game to start; this spectator stream remains joinable briefly after it begins"],
