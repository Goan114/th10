...
import { runtimeDataProvider } from "./runtime-data-provider.mjs";

export function extractGameDataLayout(runtimeScript, game) {
  if (typeof runtimeScript !== "string" || runtimeDataProvider(game).layout !== "emscripten-load-package") {
    throw new Error("invalid runtime layout input");
  }
