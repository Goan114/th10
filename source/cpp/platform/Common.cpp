...
Common::Common(AnimationEngine& e):engine(e),update_chain(&e.chain_value){
    current=&value;chain=&update_chain;callbacks=&e.callback_environment;virtual_table=1;update_callback=0x4014f0;draw_callback=0x401510;early_draw_callback=0x401520;
