...
void AnmFile::set_sprite(i32 index,const AnmSprite& source) noexcept {
    ...
    sprite.u0=(number(sprite.left)/number(sprite.texture_width)).to_float();sprite.u1=(number(sprite.right)/number(sprite.texture_width)).to_float();
    sprite.v0=(number(sprite.top)/number(sprite.texture_height)).to_float();sprite.v1=(number(sprite.bottom)/number(sprite.texture_height)).to_float();
