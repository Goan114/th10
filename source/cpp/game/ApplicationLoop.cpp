...
i32 ApplicationLoop::disable_fog(ApplicationState& app,u32& enabled,ApplicationLoopEnvironment& env){if(!enabled)return 0;env.flush();enabled=0;return env.render_state(app.device,28,0);}
