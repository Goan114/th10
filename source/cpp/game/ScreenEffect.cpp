...
void draw_screen_rectangle(const ScreenRect& rect,const u32 colors[4],AnmManager** manager,AnmRenderEnvironment& env){
    ...
    env.texture_stage(0,4,2);env.texture_stage(0,1,2);env.texture_stage(0,5,0);env.texture_stage(0,2,0);env.render_state(20,6);env.vertex_format(0x44);env.draw_triangles(5,2,vertices,20);
    ...
    env.texture_stage(0,4,4);env.texture_stage(0,1,4);env.texture_stage(0,5,2);env.texture_stage(0,2,2);
}
}
